...
<header>
    <div id="head">
        <img src="logo2.png" class="head-logo">
  ...
  <hr><br>
    <form action="" method="post" enctype="multipart/form-data">
      <dl>
        ...
        <dt><?php echo h($member['name']); ?>さん岐阜のおすすめSPOT教えてください♪</dt>
        <dd style="text-align:center;">
          <textarea name="message" cols="50" rows="3"><?php echo h($message,ENT_QUOTES); ?></textarea>
